...
class TripController extends Controller
{
  ...
  //we have to design a interface such that only trip organiser can see create , update and delete forms.
    ...
    public function delete($id,Request $request)
   {
    ...
    { 
        if($trip_organiser==Trip::where('trip_id','=',$id)->value('trip_org_email')){
    ...
    public function update($id,Request $request)
   {
    ...
    {
        $user_trip_id= Trip_participation::where('user_email',$email)->where('trip_status','=','end')->value('trip_id');
    ...
    {
        $user_trip_id= Trip_participation::where('user_email',$email)->where('trip_status','=','running')->value('trip_id')->distinct();
                                                                              //trip_status== 'start' // 
        $trip=array();
        $i=1;
        foreach ($user_trip_id as $key => $user) 
    ...
    public function show_trip_detail($trip_id)
    {
          ...
          $user_email= Trip_participation::where('trip_id',$trip_id)->value('email')->distinct();
            $user = array();
            $i=1;
...
//show all trips user_wise
    ...
    {
        $user_trip_id= Trip_participation::where('user_email',$email)->value('trip_id')->distinct();
                                                                              //trip_status== 'start' // 
        $trip=array();
        $i=1;
        foreach ($user_trip_id as $key => $user) 
